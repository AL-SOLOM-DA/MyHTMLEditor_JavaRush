...
import com.solomanin.actions.*;
import com.solomanin.listeners.TextEditMenuListener;
import com.solomanin.listeners.UndoMenuListener;
...
public class MenuHelper {
    ...
    public static void initAlignMenu(View view, JMenuBar menuBar){
        ...
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Align left", StyleConstants.ALIGN_LEFT));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Align center", StyleConstants.ALIGN_CENTER));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("Align right", StyleConstants.ALIGN_RIGHT));
    ...
    public static void initEditMenu(View view, JMenuBar menuBar){
        ...
        JMenuItem redoItem = addMenuItem(editMenu, "Return", new RedoAction(view));
